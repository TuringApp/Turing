...
ALGOBOX_POS_MINIMUM = lambda lst, p, n: lst[p:n + 1].index(ALGOBOX_MINIMUM(lst[p:n + 1]))
ALGOBOX_POS_MAXIMUM = lambda lst, p, n: lst[p:n + 1].index(ALGOBOX_MAXIMUM(lst[p:n + 1]))
