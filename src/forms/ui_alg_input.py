...
class Ui_AlgoInputStmt(object):
    def setupUi(self, AlgoInputStmt):
        ...
        self.gridLayout.addWidget(self.txtValue, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnCode, 3, 2, 1, 1)
        self.cbxHasValue = QtWidgets.QCheckBox(AlgoInputStmt)
        self.cbxHasValue.setObjectName("cbxHasValue")
        self.gridLayout.addWidget(self.cbxHasValue, 2, 1, 1, 1)
        ...
        self.cbxText = QtWidgets.QCheckBox(AlgoInputStmt)
        self.cbxText.setObjectName("cbxText")
        self.gridLayout.addWidget(self.cbxText, 1, 1, 1, 1)
    ...
    def retranslateUi(self, AlgoInputStmt):
        ...
        self.cbxText.setText(_translate("AlgoInputStmt", "Text"))
