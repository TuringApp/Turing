...
class Ui_AlgoDisplayStmt(object):
    def setupUi(self, AlgoDisplayStmt):
        ...
        self.cbxNewline = QtWidgets.QCheckBox(AlgoDisplayStmt)
        self.cbxNewline.setChecked(True)
        self.cbxNewline.setObjectName("cbxNewline")
        self.gridLayout.addWidget(self.cbxNewline, 1, 1, 1, 1)
    ...
    def retranslateUi(self, AlgoDisplayStmt):
        ...
        self.cbxNewline.setText(_translate("AlgoDisplayStmt", "Followed by a line break"))
