...
themes = {
    ...
    "darkred": (translate("Themes", "Dark red"), ["#50453a", "#ebebeb", "#c5b0b0", "#8a7366", "#7a6154", "#ffffdc", "#ebebeb", "#ebebeb", "#bebebe", "#c5b0b0", "#382626", "#6c4e4e", "#ebebeb", "#c5b0b0", "#f1ecec", "#df691a", "#308cc6", "#607d8b", "#ffffff", "#ffffff", "#eb932f", "#7cfc00", "#00ecec", "#ff7da6"]),
